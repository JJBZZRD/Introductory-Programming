...
class ManageList(BaseFrame):
    def __init__(self, parent):
        super().__init__(parent)
        # Manage List specific setup

class EditDetails(BaseFrame):
    def __init__(self, parent):
        super().__init__(parent)
        # Edit Details specific setup

import tkinter as tk
from tkinter import ttk
from UI_header import UIHeader
# Assuming AdminDashboard is correctly imported from its module
from admin_interface.admin_dashboard import AdminDashboard
...
if __name__ == "__main__":
    root = tk.Tk()
    root.title("Admin Plans")

    # Assuming you have a function or method that acts as a callback for screen transitions
    def switch_screen(screen_class):
        # Implement the screen transition logic here
        pass

    admin_plans_screen = AdminPlansScreen(root, switch_screen)
    admin_plans_screen.pack(expand=True, fill='both')
