...
class CampDataRetrieve:
    ...
    def get_stats_triage_category(campID):
        ...
        lists = {
            category: PersonDataRetrieve.get_refugees(
                camp_id=campID, triage_category=category
            )
    ...
    def get_stats_gender(campID):
        ...
        if (
            isinstance(list_male, list)
            and isinstance(list_female, list)
            and isinstance(list_other, list)
        ):
